...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _303: o => String(o),
      _304: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _305: o => {
      ...
      _2222: x0 => x0.location,
      _2524: x0 => x0.pathname,
      _2565: x0 => x0.filename,
      _2566: x0 => x0.lineno,
      _2711: x0 => x0.port1,
      _2712: x0 => x0.port2,
      _2715: (x0,x1) => { x0.onmessage = x1 },
      _2717: (x0,x1) => { x0.onmessageerror = x1 },
      _2772: (x0,x1) => { x0.onmessage = x1 },
      _2783: (x0,x1) => { x0.onmessage = x1 },
      _2785: (x0,x1) => { x0.onmessageerror = x1 },
      _2787: (x0,x1) => { x0.onerror = x1 },
      _7326: x0 => x0.status,
      _7327: x0 => x0.ok,
