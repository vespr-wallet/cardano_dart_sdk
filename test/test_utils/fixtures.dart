...
CardanoTransactionBody txBody({
  ...
  BigInt? currentTreasuryValue, // 21
  BigInt? donation, // 22
}) => CardanoTransactionBody.create(
  inputs: inputs,
  outputs: outputs,
  fee: fee?.toCborInt() ?? BigInt.zero.toCborInt(),
  ttl: ttl?.toCborInt(),
  certs: certs,
  withdrawals: withdrawals,
  metadataHash: metadataHash,
  validityStartInterval: validityStartInterval?.toCborInt(),
  mint: mint,
  ...
  totalCollateral: totalCollateral?.toCborInt(),
