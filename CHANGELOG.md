...
Web workers built with Flutter 3.41.4 and cardano_dart_types 3.0.0

### Fix

- Web WASM Worker loading (WASM loader was not compatible with assets generated by latest squadron / squadron_builder)
