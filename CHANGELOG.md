...
Web workers built with Flutter 3.41.4 | Dart 3.11.1 and cardano_dart_types 3.0.0

### Fix

- Web WASM Worker loading (dart ^3.11.0 was not working because of a change in dart2wasm)

### Change

- Bumped dart sdk to ^3.11.0 because the web wasm workers will likely not work with older dart version (due to latest fix)

## 4.0.1

Retracted (same changes like 4.0.1+1, except the min dart version was not bumped)
